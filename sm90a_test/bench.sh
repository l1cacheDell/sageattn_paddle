...
SEQ_LEN=4096
/opt/nvidia/nsight-systems/2023.1.1/bin/nsys profile -o all3_${SEQ_LEN} --cuda-memory-usage true --stats=true python test_all.py --batch_size 2 --num_heads 64 --head_dim 128 --seq_len ${SEQ_LEN}
/opt/nvidia/nsight-systems/2023.1.1/bin/nsys profile -o append_attn_${SEQ_LEN} --cuda-memory-usage true --stats=true python test_append_attn_std.py
