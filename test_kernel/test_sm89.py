from paddle_sageattn import sageattn_qk_int8_pv_fp8_cuda_sm89
import paddle
...
o1 = sageattn_qk_int8_pv_fp8_cuda_sm89(q, k, v, tensor_layout=tensor_layout, is_causal=is_causal, return_lse=return_lse)
