...
q_paddle = paddle.randn((bsz, seq_len, num_heads, head_dim_qk), dtype=paddle.float16)
k_paddle = paddle.randn((bsz, seq_len, num_heads, head_dim_qk), dtype=paddle.float16)
v_paddle = paddle.randn((bsz, seq_len, num_heads, head_dim_v), dtype=paddle.float16)
